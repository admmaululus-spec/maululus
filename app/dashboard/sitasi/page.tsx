...
export default function SitasiPage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      // 2. Panggil API Sitasi (Pastikan kamu sudah buat route /api/sitasi seperti diskusi sebelumnya)
      ...
      <main className="max-w-4xl mx-auto px-6 py-10">
        <div className="mb-8 flex items-start gap-5">
          ...
          <div>
            ...
            <p className="text-slate-500 mt-2 text-sm max-w-xl">Ubah judul jurnal, DOI, atau link menjadi format Daftar Pustaka (Bibliography) dan kutipan yang siap dipakai di skripsi.</p>
          </div>
        </div>
          ...
          <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm flex flex-col gap-4">
            <div>
              ...
              <select 
                ...
                className="w-full bg-slate-50 border border-slate-200 text-slate-800 rounded-xl p-3 outline-none focus:border-purple-500"
              >
            ...
            <div className="flex-1">
              ...
              <textarea
                ...
                placeholder="Contoh: Pengaruh Sistem Informasi Geografis Terhadap... atau tempelkan link jurnal disini."
            ...
            >
              {isProcessing ? 'Sedang Menyusun...' : `Buat Sitasi (-${HARGA_KOIN} Koin)`}
            </button>
          </div>
            ...
            {isProcessing ? (
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="bg-white border border-purple-100 p-4 rounded-xl text-sm font-semibold text-slate-800 shadow-sm">
                ...
                <div>
                  ...
                  <div className="bg-white border border-purple-100 p-4 rounded-xl text-sm text-slate-800 shadow-sm">
                    {result.bibliography}
                  </div>
                </div>
              </div>
              ...
              <div className="flex-1 flex flex-col items-center justify-center text-slate-400 opacity-60">
                ...
                <p className="text-sm">Hasil sitasi akan muncul di sini</p>
              </div>
            )}
          </div>
        </div>
