...
export default function DashboardPage() {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      // 1. SINKRONISASI DARI LOCAL STORAGE
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900 pb-20 selection:bg-emerald-200">
      ...
      <header className="bg-white/80 backdrop-blur-xl border-b border-slate-100 sticky top-0 z-50 transition-all">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            {isPro ? (
              <span className="flex items-center gap-1 rounded-full bg-gradient-to-r from-emerald-500 to-teal-500 px-2.5 py-0.5 text-[10px] font-bold text-white uppercase tracking-widest shadow-sm">
                Pro
              </span>
            ) : (
          ...
          <div className="flex items-center gap-5">
            <div className="flex items-center gap-1.5 bg-emerald-50 border border-emerald-100 px-3 py-1.5 rounded-full shadow-sm">
        ...
        {activeTab === 'overview' && (
          <div className="animate-in fade-in slide-in-from-bottom-2 duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-14">
              ...
              <Link href="/generator" className="group relative bg-white border border-slate-200 p-6 rounded-[2rem] shadow-sm hover:shadow-[0_8px_30px_rgb(0,0,0,0.06)] hover:-translate-y-1 hover:border-emerald-200 transition-all duration-300 overflow-hidden">
                <div className="absolute top-0 right-0 p-6 opacity-5 group-hover:opacity-10 transition-opacity">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-24 h-24 text-emerald-500"><path d="M12 3L1 9l4 2.18v6L12 21l7-3.82v-6l2-1.09V17h2V9L12 3zm6.82 6L12 12.72 5.18 9 12 5.28 18.82 9zM17 15.99l-5 2.73-5-2.73v-3.72L12 15l5-2.73v3.72z"/></svg>
                </div>
              ...
              <Link href="/dashboard/copilot" className="group relative bg-white border border-slate-200 p-6 rounded-[2rem] shadow-sm hover:shadow-[0_8px_30px_rgb(0,0,0,0.06)] hover:-translate-y-1 hover:border-emerald-200 transition-all duration-300 overflow-hidden">
                <div className="absolute top-0 right-0 p-6 opacity-5 group-hover:opacity-10 transition-opacity">
                   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-24 h-24 text-emerald-600"><path d="M19.045 7.401c.378-.378.586-.88.586-1.414s-.208-1.036-.586-1.414l-1.586-1.586c-.378-.378-.88-.586-1.414-.586s-1.036.208-1.414.586l-1.586 1.586c-.378.378-.586.88-.586 1.414s.208 1.036.586 1.414l1.586 1.586c.378.378.88.586 1.414.586s1.036-.208 1.414-.586l1.586-1.586zM20.459 6.2c.2.2.2.51 0 .71l-1.586 1.586c-.2.2-.51.2-.71 0l-1.586-1.586c-.2-.2-.2-.51 0-.71l1.586-1.586c.2-.2.51-.2.71 0l1.586 1.586zM4 20h2.586L15.172 11.414 12.586 8.828 4 17.414V20z"/></svg>
                </div>
            ...
            <section>
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="bg-slate-100 text-slate-500 text-[10px] font-bold px-2.5 py-1 rounded-lg border border-slate-200">{riwayatList.length} File</span>
              </div>
              ...
              <div className="space-y-3">
                {riwayatList.length > 0 ? (
                  ...
                  <div className="py-20 bg-slate-50 border border-slate-200 border-dashed rounded-[2rem] text-center flex flex-col items-center justify-center">
                    <div className="h-12 w-12 bg-white border border-slate-200 rounded-full flex items-center justify-center mb-4 text-slate-300">
