...
export function ToolItem({ icon, label, coin, isHot, isFree, color, bg, href }: any) {
  return (
    <Link href={href || "#"} className="flex flex-col items-center justify-center text-center p-3 rounded-2xl hover:bg-slate-50 transition-all duration-300 cursor-pointer border border-transparent hover:border-slate-200 hover:shadow-sm active:scale-95 group">
       <div className={`relative w-14 h-14 flex items-center justify-center text-3xl ${bg} rounded-xl mb-3 group-hover:-translate-y-1 transition-transform`}>
