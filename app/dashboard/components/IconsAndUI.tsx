...
export function ToolItem({ icon, label, coin, isHot, isFree, href }: any) {
  return (
    <Link href={href || "#"} className="flex flex-col items-center justify-center text-center p-4 rounded-2xl bg-white border border-slate-200 hover:border-blue-300 hover:shadow-md hover:bg-blue-50/30 transition-all duration-300 cursor-pointer active:scale-95 group">
       ...
       {isFree ? (
         ...
         <p className="text-[10px] font-bold text-amber-500 flex items-center gap-1 bg-amber-50 px-2.5 py-1 rounded-lg border border-amber-100">🪙 {coin} Koin</p>
       )}
    </Link>
  );
}
...
// SVGs Khusus Fitur & Premium (Pengganti Emoji)
